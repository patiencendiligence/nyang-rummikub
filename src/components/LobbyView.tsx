...
export const LobbyView: React.FC<LobbyViewProps> = ({
  ...
  return (
    <div className="max-w-7xl mx-auto px-3 py-6 sm:px-8 flex flex-col xl:flex-row gap-6">
      ...
      <div className="w-full xl:w-[420px] xl:flex-none flex flex-col min-w-0">
        <div
          className={`flex flex-col w-full min-h-[300px] h-[min(70vh,520px)] max-h-[520px] overflow-hidden transition-all ${
            isDefault
        ...
        >
          ...
          {/* Chat Messages Log */}
          <div
            className={`m-3 p-3 flex-1 min-h-0 rounded-2xl overflow-y-auto flex flex-col gap-2 transition-all ${
              isDefault
                ? 'plush-debossed'
