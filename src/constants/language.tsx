...
type TranslationKey =
  ...
  | 'playWithBot' | 'bot' | 'computerMatch'
  | 'playAgain' | 'backToWaitingRoom' | 'leaveToLobby' | 'restartGame' | 'waitingForHostRestart';
...
const translations: Record<Language, Record<TranslationKey, string>> = {
  ko: {
    ...
    playWithBot: '컴퓨터와 대결하기', bot: '컴퓨터(AI)', computerMatch: 'AI 봇 채우기',
    playAgain: '같은 멤버와 한판 더!', backToWaitingRoom: '대기실로 돌아가기', leaveToLobby: '로비로 나가기', restartGame: '다시 시작하기', waitingForHostRestart: '방장이 새 게임을 시작하기를 기다리는 중입니다...',
  },
  en: {
    ...
    playWithBot: 'Play with Computer', bot: 'Computer(AI)', computerMatch: 'Fill with AI Bots',
    playAgain: 'Rematch with same members!', backToWaitingRoom: 'Return to Waiting Room', leaveToLobby: 'Leave to Lobby', restartGame: 'Restart Match', waitingForHostRestart: 'Waiting for host to restart the game...',
  },
};
