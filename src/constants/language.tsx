...
const translations: Record<Language, Record<TranslationKey, string>> = {
  ko: {
    brand: '냥루미큐브 온라인', nicknamePlaceholder: '닉네임 입력', nicknameChange: '닉네임 변경', rules: '게임 룰 설명', dashboard: '전적 대시보드',
  ...
  en: {
    brand: 'Nyang Rummikub Online', nicknamePlaceholder: 'Enter nickname', nicknameChange: 'Change nickname', rules: 'Game rules', dashboard: 'Stats dashboard',
